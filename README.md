...
| 2 | 3000. | Maximum Area of Longest Diagonal Rectangle | [Link](https://leetcode.com/problems/maximum-area-of-longest-diagonal-rectangle/) | LeetCode | O(n) | O(1) |
| 3 | 3195. | Minimum Area to Cover All Ones | [Link](https://leetcode.com/problems/minimum-area-to-cover-all-ones/) | LeetCode | O(m * n) | O(1) |
| 4 | 90. | Subsets II | [Link](https://leetcode.com/problems/subsets-ii/) | LeetCode | O(n^2 log n) | O(n^2) |
| 5 | 1508. | Range Sum of Sorted Subarray Sums | [Link](https://leetcode.com/problems/range-sum-of-sorted-subarray-sums) | LeetCode | O(n^2 log n) | O(n^2) |
| 6 | 991. | Broken Calculator | [Link](https://leetcode.com/problems/broken-calculator/) | LeetCode | O(log(target/startValue)) | O(1) |
| 7 | 1833. | Maximum Ice Cream Bars | [Link](https://leetcode.com/problems/maximum-ice-cream-bars/description/) | LeetCode | O(n log n) | O(1) |
| 8 | 27. | Remove Element | [Link](https://leetcode.com/problems/remove-element/) | LeetCode | O(n) | O(1) |
| 9 | 26. | Remove Duplicates from Sorted Array | [Link](https://leetcode.com/problems/remove-duplicates-from-sorted-array/) | LeetCode | O(n log n) | O(1) |
| 10 | 435. | Non-overlapping Intervals | [Link](https://leetcode.com/problems/non-overlapping-intervals/) | LeetCode | O(n log n) | O(1) |
| 11 | 1582. | Special Positions in a Binary Matrix | [Link](https://leetcode.com/problems/special-positions-in-a-binary-matrix/description/) | LeetCode | O(m * n) | O(1) |
| 12 | 80. | Remove Duplicates from Sorted Array II | [Link](https://leetcode.com/problems/remove-duplicates-from-sorted-array-ii/) | LeetCode | O(n) | O(1) |
| 13 | 2270. | Valid Split of an Array | [Link](https://leetcode.com/problems/number-of-ways-to-split-array/) | LeetCode | O(n) | O(1) |
| 14 | 77. | Combinations | [Link](https://leetcode.com/problems/combinations/) | LeetCode | O(n! / (k! * (n - k)!)) | O(k) |
| 15 | 202. | Happy Number | [Link](https://leetcode.com/problems/happy-number/) | LeetCode | O(log n) | O(1) |
| 16 | 56. | Merge Intervals | [Link](https://leetcode.com/problems/merge-intervals/) | LeetCode | O(n log n) | O(n) |
| 17 | 88. | Merge Sorted Array | [Link](https://leetcode.com/problems/merge-sorted-array/) | LeetCode | O((m + n) log(m + n)) | O(1) |
| 18 | 921. | Minimum Add to Make Parentheses Valid | [Link](https://leetcode.com/problems/minimum-add-to-make-parentheses-valid/) | LeetCode | O(n) | O(n) |
...
| 7 | 1545. | Find Kth Bit in Nth Binary String | [Link](https://leetcode.com/problems/find-kth-bit-in-nth-binary-string/) | LeetCode | O(n * k) | O(n) |
| 8 | - | Find XOR of Numbers from L to R | [Link](https://www.geeksforgeeks.org/problems/find-xor-of-numbers-from-l-to-r/1) | GfG | O(1) | O(1) |
| 9 | 869. | Reordered Power of 2 | [Link](https://leetcode.com/problems/reordered-power-of-2/description/) | LeetCode | O(n log n) | O(n) |
| 10 | 137. | Single Number II | [Link](https://leetcode.com/problems/single-number-ii/) | LeetCode | O(n) | O(1) |
| 11 | - | Set the Rightmost Unset Bit | [Link](https://www.geeksforgeeks.org/problems/set-the-rightmost-unset-bit4436/1) | GfG | O(1) | O(1) |
| 12 | 2220. | Minimum Bit Flips to Convert Number | [Link](https://leetcode.com/problems/minimum-bit-flips-to-convert-number/) | LeetCode | O(log n) | O(1) |
| 13 | - | Find First Set Bit | [Link](https://www.geeksforgeeks.org/problems/find-first-set-bit-1587115620/1) | GfG | O(log n) | O(1) |
| 14 | - | Check Kth Bit Set or Not | [Link](https://www.geeksforgeeks.org/check-kth-bit-set-not/) | GfG | O(1) | O(1) |
| 15 | - | Swap Two Numbers | [Link](https://www.geeksforgeeks.org/problems/swap-two-numbers3844/1) | GfG | O(1) | O(1) |
| 16 | - | Print All Bitwise Subsets of a Number | [Link](https://www.geeksforgeeks.org/problems/print-all-bitwise-subsets-of-a-number-n3301/1) | GfG | O(n) | O(n) |
| 17 | 136. | Single Number | [Link](https://leetcode.com/problems/single-number/) | LeetCode | O(n) | O(1) |
| 18 | 342. | Power of Four | [Link](https://leetcode.com/problems/power-of-four/) | LeetCode | O(1) | O(1) |
| 19 | 67. | Add Binary | [Link](https://leetcode.com/problems/add-binary/) | LeetCode | O(max(m, n)) | O(max(m, n)) |
| 20 | 191. | Number of 1 Bits | [Link](https://leetcode.com/problems/number-of-1-bits/) | LeetCode | O(log n) | O(1) |
...
| S.No | QuestionNumber | Title | Link | Platform | Time | Space |
|---|---|---|---|---|---|---|
| 1 | 221. | Maximal Square | [Link](https://leetcode.com/problems/maximal-square/description/) | LeetCode | O(m * n) | O(m * n) |
| 2 | 70. | Climbing Stairs | [Link](https://leetcode.com/problems/climbing-stairs/) | LeetCode | O(n) | O(n) |
| 3 | - | Matrix Chain Multiplication | [Link](https://www.geeksforgeeks.org/problems/matrix-chain-multiplication0303/1) | GfG | O(n^3) | O(n^2) |
| 4 | 63. | Unique Paths II | [Link](https://leetcode.com/problems/unique-paths-ii/description/) | LeetCode | O(m * n) | O(m * n) |
| 5 | 509. | Fibonacci Number | [Link](https://leetcode.com/problems/fibonacci-number/description/) | LeetCode | O(n) | O(n) |
| 6 | 62. | Unique Paths | [Link](https://leetcode.com/problems/unique-paths/description/) | LeetCode | O(m * n) | O(m * n) |
| 7 | 139. | Word Break | [Link](https://leetcode.com/problems/word-break/description/) | LeetCode | O(n^2 * m) | O(n) |
| 8 | 120. | Triangle | [Link](https://leetcode.com/problems/triangle/) | LeetCode | O(n^2) | O(n) |
| 9 | 516. | Longest Palindromic Subsequence | [Link](https://leetcode.com/problems/longest-palindromic-subsequence/description) | LeetCode | O(n^2) | O(n^2) |
| 10 | 213. | House Robber II | [Link](https://leetcode.com/problems/house-robber-ii/description/) | LeetCode | O(n) | O(n) |
| 11 | 416. | Partition Equal Subset Sum | [Link](https://leetcode.com/problems/partition-equal-subset-sum/) | LeetCode | O(n * sum) | O(n * sum) |
| 12 | 837. | New 21 Game | [Link](https://leetcode.com/problems/new-21-game/description/) | LeetCode | O(n) | O(n) |
| 13 | 123. | Best Time to Buy and Sell Stock III | [Link](https://leetcode.com/problems/best-time-to-buy-and-sell-stock-iii/description/?envType=study-plan-v2&envId=top-interview-150) | LeetCode |  |  |
| 14 | 198. | House Robber | [Link](https://leetcode.com/problems/house-robber/description/) | LeetCode | O(n) | O(n) |
| 15 | 1143. | Longest Common Subsequence | [Link](https://leetcode.com/problems/longest-common-subsequence/description/) | LeetCode | O(n * m) | O(n * m) |
| 16 | - | Perfect Sum Problem | [Link](https://www.geeksforgeeks.org/problems/perfect-sum-problem5633/1) | GfG | O(n * target) | O(target) |
| 17 | - | 0/1 Knapsack Problem | [Link](https://www.geeksforgeeks.org/problems/0-1-knapsack-problem0945/1) | GfG | O(n * W) | O(n * W) |
| 18 | 1137. | N-th Tribonacci Number | [Link](https://leetcode.com/problems/n-th-tribonacci-number/) | LeetCode | O(n) | O(n) |
| 19 | - | Subset Sum Problem | [Link](https://www.geeksforgeeks.org/problems/subset-sum-problem-1611555638/1) | GfG | O(n * sum) | O(n * sum) |
| 20 | 64. | Minimum Path Sum | [Link](https://leetcode.com/problems/minimum-path-sum/description/) | LeetCode | O(m * n) | O(1) |
...
| [0153-find-minimum-in-rotated-sorted-array](https://github.com/suryanandanbabbar/LeetCode/tree/main/0153-find-minimum-in-rotated-sorted-array/) | Medium |
...
| [1288-remove-covered-intervals](https://github.com/suryanandanbabbar/LeetCode/tree/main/1288-remove-covered-intervals/) | Medium |
...
| [1406-stone-game-iii](https://github.com/suryanandanbabbar/LeetCode/tree/main/1406-stone-game-iii/) | Hard |
| [1464-maximum-product-of-two-elements-in-an-array](https://github.com/suryanandanbabbar/LeetCode/tree/main/1464-maximum-product-of-two-elements-in-an-array/) | Easy |
...
| [1967-number-of-strings-that-appear-as-substrings-in-word](https://github.com/suryanandanbabbar/LeetCode/tree/main/1967-number-of-strings-that-appear-as-substrings-in-word/) | Easy |
| [1979-find-greatest-common-divisor-of-array](https://github.com/suryanandanbabbar/LeetCode/tree/main/1979-find-greatest-common-divisor-of-array/) | Easy |
...
| [2161-partition-array-according-to-given-pivot](https://github.com/suryanandanbabbar/LeetCode/tree/main/2161-partition-array-according-to-given-pivot/) | Medium |
| [2215-find-the-difference-of-two-arrays](https://github.com/suryanandanbabbar/LeetCode/tree/main/2215-find-the-difference-of-two-arrays/) | Easy |
...
| [3513-number-of-unique-xor-triplets-i](https://github.com/suryanandanbabbar/LeetCode/tree/main/3513-number-of-unique-xor-triplets-i/) | Medium |
...
| [3546-equal-sum-grid-partition-i](https://github.com/suryanandanbabbar/LeetCode/tree/main/3546-equal-sum-grid-partition-i/) | Medium |
| [3548-equal-sum-grid-partition-ii](https://github.com/suryanandanbabbar/LeetCode/tree/main/3548-equal-sum-grid-partition-ii/) | Hard |
| [3699-number-of-zigzag-arrays-i](https://github.com/suryanandanbabbar/LeetCode/tree/main/3699-number-of-zigzag-arrays-i/) | Hard |
...
| [3020-find-the-maximum-number-of-elements-in-subset](https://github.com/suryanandanbabbar/LeetCode/tree/main/3020-find-the-maximum-number-of-elements-in-subset/) | Medium |
| [3345-smallest-divisible-digit-product-i](https://github.com/suryanandanbabbar/LeetCode/tree/main/3345-smallest-divisible-digit-product-i/) | Easy |
...
| [1207-unique-number-of-occurrences](https://github.com/suryanandanbabbar/LeetCode/tree/main/1207-unique-number-of-occurrences/) | Easy |
| [1345-jump-game-iv](https://github.com/suryanandanbabbar/LeetCode/tree/main/1345-jump-game-iv/) | Hard |
| [1358-number-of-substrings-containing-all-three-characters](https://github.com/suryanandanbabbar/LeetCode/tree/main/1358-number-of-substrings-containing-all-three-characters/) | Medium |
| [1674-minimum-moves-to-make-array-complementary](https://github.com/suryanandanbabbar/LeetCode/tree/main/1674-minimum-moves-to-make-array-complementary/) | Medium |
| [2215-find-the-difference-of-two-arrays](https://github.com/suryanandanbabbar/LeetCode/tree/main/2215-find-the-difference-of-two-arrays/) | Easy |
| [2657-find-the-prefix-common-array-of-two-arrays](https://github.com/suryanandanbabbar/LeetCode/tree/main/2657-find-the-prefix-common-array-of-two-arrays/) | Medium |
| [2784-check-if-array-is-good](https://github.com/suryanandanbabbar/LeetCode/tree/main/2784-check-if-array-is-good/) | Easy |
...
| [2033-minimum-operations-to-make-a-uni-value-grid](https://github.com/suryanandanbabbar/LeetCode/tree/main/2033-minimum-operations-to-make-a-uni-value-grid/) | Medium |
| [2946-matrix-similarity-after-cyclic-shifts](https://github.com/suryanandanbabbar/LeetCode/tree/main/2946-matrix-similarity-after-cyclic-shifts/) | Easy |
| [3014-minimum-number-of-pushes-to-type-word-i](https://github.com/suryanandanbabbar/LeetCode/tree/main/3014-minimum-number-of-pushes-to-type-word-i/) | Easy |
| [3300-minimum-element-after-replacement-with-digit-sum](https://github.com/suryanandanbabbar/LeetCode/tree/main/3300-minimum-element-after-replacement-with-digit-sum/) | Easy |
| [3312-sorted-gcd-pair-queries](https://github.com/suryanandanbabbar/LeetCode/tree/main/3312-sorted-gcd-pair-queries/) | Hard |
| [3345-smallest-divisible-digit-product-i](https://github.com/suryanandanbabbar/LeetCode/tree/main/3345-smallest-divisible-digit-product-i/) | Easy |
| [3464-maximize-the-distance-between-points-on-a-square](https://github.com/suryanandanbabbar/LeetCode/tree/main/3464-maximize-the-distance-between-points-on-a-square/) | Hard |
...
| [3751-total-waviness-of-numbers-in-range-i](https://github.com/suryanandanbabbar/LeetCode/tree/main/3751-total-waviness-of-numbers-in-range-i/) | Medium |
| [3753-total-waviness-of-numbers-in-range-ii](https://github.com/suryanandanbabbar/LeetCode/tree/main/3753-total-waviness-of-numbers-in-range-ii/) | Hard |
...
| [0023-merge-k-sorted-lists](https://github.com/suryanandanbabbar/LeetCode/tree/main/0023-merge-k-sorted-lists/) | Hard |
| [0024-swap-nodes-in-pairs](https://github.com/suryanandanbabbar/LeetCode/tree/main/0024-swap-nodes-in-pairs/) | Medium |
| [0141-linked-list-cycle](https://github.com/suryanandanbabbar/LeetCode/tree/main/0141-linked-list-cycle/) | Easy |
| [0146-lru-cache](https://github.com/suryanandanbabbar/LeetCode/tree/main/0146-lru-cache/) | Medium |
| [0160-intersection-of-two-linked-lists](https://github.com/suryanandanbabbar/LeetCode/tree/main/0160-intersection-of-two-linked-lists/) | Easy |
...
| Problem Name | Difficulty |
| ------- | ------- |
| [0181-employees-earning-more-than-their-managers](https://github.com/suryanandanbabbar/LeetCode/tree/main/0181-employees-earning-more-than-their-managers/) | Easy |
<!---LeetCode Topics End-->